...
// - _formatWeekRangeET_(d)
// - _findActiveIndexByDate_(sheet)
// - _blockTopForIndex_(idx)
// - weekKey_(week)
// - getAllBlocks_(sh)
// - resolveDivisionBlockTop_(division, week)
...
function getAlignedUpcomingWeekOrReport_() {
  var G = _gridMeta_(); var gold = getSheetByName('Gold');
